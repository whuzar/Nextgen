...
public class AdminIdeasList extends AppCompatActivity {
    private RecyclerView recyclerView;
    SharedPreferences sharedPreferences;
    private static final String SHARED_PREF_NAME = "mypref";
    private static final String KEY_LOGED = "wloged";
    private static final String KEY_LOGIN = "login";
    myadapterAdminIdea adapter;
    private String who;
    private String team;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_ideas_list);
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference();

        recyclerView = findViewById(R.id.adminIdeaRecycler);
        ...
        databaseReference.child(who).child(login).child("team").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                if (!task.isSuccessful()) {
                    ...
                    adapter = new myadapterAdminIdea(options);
